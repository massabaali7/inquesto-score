...
Paper: *Inquesto Score: A Reliability Protocol for Voice Agents* (Baali & Raj, arxiv 2026). Specification: [docs/inquesto-score-v0.1.md](docs/inquesto-score-v0.1.md). Records for the 13 agents in the paper: [records/](records/).

## Get a score in three commands

```bash
pip install "inquesto-score[audio]"      # Python 3.10+  (until the PyPI release: pip install "inquesto-score[audio] @ git+https://github.com/massabaali7/inquesto-score")
